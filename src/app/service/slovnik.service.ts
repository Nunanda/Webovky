...
import { Styl } from '../types'
 ...
 const poleStylu: Array<Styl> = [{nazev: "retizkove-oko", titulek: "Řetízkové oko", zkratka: "Řo", popis: "Vytvoříme si jednoduchý uzlík, který upevníme přímo na háček. Utahujeme pouze tak, aby prošla další příze. Naberu na háček a přitáhnu vytvořeným okem. Opakováním tohoto tahu vytvářím řetěz." },
  {nazev: "pevne-oko", titulek: "Pevné oko", zkratka: "Po", popis: "Ve vytvořené řadě výrobku si mohu udělat pevná oka. Pomáhají tvarovat záhyby, lokty, kolena nebo zakončují výrobek. To oka zajedu háčkem a přitáhnu přízi na druhou stranu, ale tentokrát narozdíl od ks tu druhou přízi přitáhnu tou první. Čím více budu utahovat, tím hůř se do něj pak dostanu. Pokud zakončujete, tak se v tomto bodě už jen ustřihne dostatečně dlouhá část příze na přišití a protáhnete konec vytvořeným okem na háčku." },
  {nazev: "kratky-sloupek", titulek: "Krátký sloupek", zkratka: "Ks", popis: "Do vytvořené řady řo najdu první oko. Do oka zajedu háčkem a protáhnu přízí na druhou stranu. Na háčku se mi nyní objeví 2 nahozené provázky, znovu naberu přízi na háček a provleču ji těma dvěma, co už tam čekaly." },
  {nazev: "dlouhy-sloupek", titulek: "Dlouhý sloupek", zkratka: "Ds", popis: "Nabereme přízi na háček a teprve potom zajedeme do vytvořeného oka. Máme 3 příze na háčku. Naberu a protahuju po dvou. Takže první dvojicí protáhnu první nahození, pak zase naberu a protáhnu zbylými dvěma" },
  {nazev: "polodlouhy-sloupek", titulek: "Polodlouhý sloupek", zkratka: "Pds", popis: "Nabereme přízi na háček a teprve potom zajedeme do vytvořeného oka. Protáhnu a na háčku mám nyní 3krát ovinutou přízi. Naberu na háček a tuto přízi protáhnu všemi třemi." },
  {nazev: "rozhackovani", titulek: "Rozháčkování", zkratka: "V", popis: "Krátký sloupek tak, jak ho známe, ale uděláme ho dvakrát v jednom bodě" },
