...
const poleStyluCZ: Array<Styl> = [
  {
    ...
    title: "Řetízkové oko",
    zkratka: "Řo",
    popis: "Vytvoříme si jednoduchý uzlík, který upevníme přímo na háček. Utahujeme pouze tak, aby prošla další příze. Naberu na háček a protáhnu vytvořeným okem. Opakováním tohoto tahu vytvářím řetěz."
  },

  {
    ...
    title: "Pevné oko",
    zkratka: "Po",
    popis: "Ve vytvořené řadě výrobku si mohu udělat pevná oka. Pomáhají tvarovat záhyby, lokty, kolena nebo zakončují výrobek. Do oka zajedu háčkem a protáhnu přízi na druhou stranu, ale tentokrát narozdíl od Ks tu druhou přízi protáhnu tou první. Čím více budu utahovat, tím hůř se do něj pak dostanu. Pokud zakončujete, tak se v tomto bodě už jen ustřihne dostatečně dlouhá část příze na přišití a protáhnete konec vytvořeným okem na háčku."
  },

  {
    ...
    zkratka: "Ks",
    popis: "Do vytvořené řady Řo najdu první oko. Do oka zajedu háčkem a protáhnu přízí na druhou stranu. Na háčku se mi nyní objeví dva nahozené provázky, znovu naberu přízi na háček a provleču ji těma dvěma, co už tam čekaly."
  },

  {
    ...
    zkratka: "Ds",
    popis: "Nabereme přízi na háček a teprve potom zajedeme do vytvořeného oka. Máme tři příze na háčku. Naberu a protahuju po dvou. Takže první dvojicí protáhnu první nahození, pak zase naberu a protáhnu zbylými dvěma."
  },

  {
    ...
    zkratka: "Pds",
    popis: "Nabereme přízi na háček a teprve potom zajedeme do vytvořeného oka. Protáhnu a na háčku mám nyní třikrát ovinutou přízi. Naberu na háček a tuto přízi protáhnu všemi třemi."
  },
...

  {
    ...
    title: "Sháčkování",
    zkratka: "A",
    popis: "Jde to dvěma různými způsoby.</p> <p>1) Protáhnu přízi dvěma po sobě následujícími oky. Držím tedy na háčku tři provázky příze. Jednou nahodím a protáhnu všemi třemi najednou.</p><p>2) Zasunu háček za přední nit a hned jdu to toho dalšího, kde taky vezmu jen přední nit. Nahodím a protahuju po dvojicích.</p> <p>U druhého způsobu se docílí toho, že nevznikají mezery mezi oky, což není vždy vidět a jde i o to, jak moc člověk utahuje. Každopádně nevýhodou je menší stahování, které se dožene šitím."
  },
