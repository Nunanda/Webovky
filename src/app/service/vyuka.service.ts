...
const poleVyrobkuCZ: Array<Vyuka> = [
  {
    ...
    kroky: [
      ...
      },
      {
        ...
        styl: "Ks",
        pouzijeme: "Háček, značkovač",
        popis: "Následující dvě řady budou stejné, abychom docílili nějakého tvaru. Rozšířili jsme dostatečně, ale za pomoci těchto řad se nám chobotnička ještě trošku zvětší. Kdybyste ji chtěli vyšší, musíte přidat více řad.",
      ...
      },
      {
        ...
        styl: "Ks, A",
        pouzijeme: "Háček, značkovač",
        popis: "Stejně jako u kroku 3 jsme zvětšovali chobotničku, tak teď ji budeme pro změnu uzavírat. Opět to napomáhá k tvarování hlavičky chobotnice. Značka <i>A</i> je stažení, jinak řečeno sháčkování. Docílíme ho za pomoci spojení dvou krátkých sloupků.",
      ...
      },
      {
        ...
        styl: "Po, Pds, Ds",
        pouzijeme: "Háček, značkovač",
        popis: "Pevné očko, polodlouhý sloupek, dlouhý sloupek, polodlouhý sloupek. Tato kombinace půjde do každého jednoho oka. Čili v konečném výsledku budeme opakovat šestkrát. Vytváříme tím obloučky, které v našem případě zastávají chapadla.</p><p>Pevné očko v tomto případě tvoří přechod mezi jednotlivými chapadly, dlouhé a polodlouhé sloupky naopak dodávají tvar.</p><p>Je to docela blízko sebe, tak dávejte pozor, ať nevynecháte.",
...

  {
    ...
    kroky: [
      ...
      },
      {
        ...
        styl: "Řo",
        pouzijeme: "Háček",
        popis: "Teď máme na háčku vytvořený uzlík, nabereme přízi a protáhneme ji okem. Zase je jedno na háčku, naberu přízi a protáhnu. Takto celkem 27 krát.",
      ...
      },
      {
        ...
        styl: "Ds, Řo",
        pouzijeme: "Háček",
        popis: "Začneme odpočítáním třetího očka, a tam vytvoříme dlouhé sloupky, celkem dva do jednoho oka. Přidáme řetízkové oko, které nám pomáhá vytvářet květy.",
      ...
      },
      {
        ...
        styl: "Ds, Řo",
        pouzijeme: "Háček",
        popis: "Abychom vynahradili mezeru vzniklou řetízkovým okem, tak jedno oko na řetězu vynecháme. Další krok tedy bude ob jedno oko. Tři dlouhé sloupky do jednoho oka, řetízkové oko a takto pořád dokola, dokud nejsme na konci.",
      ...
      },
      {
        ...
        styl: "Ds, Řo",
        pouzijeme: "Háček",
        popis: "Vytvoříme dvě řetízková oka, abych nám vznikla jakási nadstavba. Otočíme celý výrobek na druhou stranu (tzn. výrobek převrátíme) a pokračujeme druhou řadou.</p><p>Háčkujeme opakovaně dlouhý sloupek, do dalšího oka dvakrát dlouhý sloupek, další oko opět jednou a dvě řetízková oka, která ukončíme v místě předešlého řetízkového očka z kroku 3 a 4.</p><p>Konkrétně si můžete vybrat mezi krátkým sloupkem, nebo pevným očkem (obojí ukázáno na videu), rozdíl je ve stažení a tedy i mezeře mezi listy.",
      ...
      },
      {
        ...
        styl: "Ds, Řo",
        pouzijeme: "Háček",
        popis: "Pokračujeme stejným způsobem. Dvě řetízková oka, nahodím, vytvořím dlouhý sloupek do dalšího oka, pak dva dlouhé sloupky do jednoho, v dalším bude opět jedno a pak dvě řetízková oka, ukončena krátkým sloupkem, nebo pevným očkem v místě řetízkového očka předešlé řady.",
      ...
      },
      {
        ...
        styl: "Řo, Ds, Po",
        pouzijeme: "Háček",
        popis: "Poslední lístek se dělá stejně, jako ty doposud, jediný rozdíl je v tom, že poslední dvojice řetízkových oček se ukončí dvě očka dolů po straně.</p><p>Po zakončení pevným okem, máme kytičku hotovou a můžeme ji jít točit a tvarovat.",
      ...
      },
      {
        ...
        styl: "Řo",
        pouzijeme: "Háček",
        popis: "Počneme si list. Můžete jich mít libovolné množství, ale musíte se vrátit zpět k tomuto kroku, abyste mohli podle videa tvořit znova.</p><p>Uděláme 13 řetízkových ok.",
      ...
      },
      {
        ...
        styl: "Ds",
        pouzijeme: "Háček",
        popis: "Odpočítám si tři očka a do toho třetího udělám 2Ds. Další oko je pro mě obohaceno dlouhými sloupky s rozdílem toho, že místo jednoho nahození nastanou dvě. Je to pořád to samé. Do jednoho oka celkem dvakrát.",
      ...
      },
      {
        ...
        styl: "Ds",
        pouzijeme: "Háček",
        popis: "Stejně pokračuju i nadále s rozdílem toho, že do každého jednoho oka padne jeden dlouhý sloupek s dvojitým nahozením. Do následujících tří oček.",
      ...
      },
      {
        ...
        styl: "Ds, Pds",
        pouzijeme: "Háček",
        popis: "Do dvou po sobě jdoucích ok uděláme klasický dlouhý sloupek, jednou nahodím, dvakrát protáhnu. Pak polodlouhý sloupek, jednou nahodím a jednou protáhnu.",
      ...
      },
      {
        ...
        styl: "Pds, Ks",
        pouzijeme: "Háček",
        popis: "Jeden krátký sloupek, do dalšího oka tři a zase jedno. Potom děláme to samé, co na druhé straně akorát obráceně. Tak pojďme na to. Jeden polodlouhý sloupek prosím!",
      ...
      },
      {
        ...
        styl: "Ds",
        pouzijeme: "Háček",
        popis: "Dva klasické dlouhé sloupky, jedno nahození a dvě protažení. Potom třikrát dlouhý sloupek po dvou nahozeních a třech protaženích. Dvakrát do jednoho očka ten dlouhý sloupek o dvou nahozeních. Předposlední očko si ponese tři dlouhé sloupky.",
      ...
      },
      {
        ...
        styl: "Po, Řo, Ks",
        pouzijeme: "Háček",
        popis: "Pevným okem propojíme náš konec se začátkem výrobku a pokračujeme třemi řetízkovými očky. Výrobek otočím a udělám dva krátké sloupky. Pak pevným okem zakončím a mám list i s malým stonkem. Ovšem není nutný a pokud se vám nelíbí, nemusí tam vůbec být.</p><p>List přišijeme k růži.",
    ...
    kroky: [
      {
        ...
        styl: "Mr",
        pouzijeme: "Hook",
        popis: "Začneme jedním z nejtěžších stylů, a to je magický kroužek. Buď ho můžete dělat jako já na videu, nebo si práci zjednodušit za pomoci dvou řetízkových ok a následného píchnutí šestkrát do prvního oka.",
      ...
      },
      {
        ...
        styl: "V",
        pouzijeme: "Háček, značkovač",
        popis: "Označíme si nějakým způsobem začátek řady. Já mám značkovače, ale vám může stačit i nit jiné příze. Rozháčkování je o tom, že dělám dva krátké sloupky do každého jednoho oka.</p><p>První očko není vždycky úplně zřetelné a mnohdy se do něj nedá ani dostat, to je ovšem ovlivněno samotným utahováním.</p><p>Nit, kterou jsem kroužek stahovala, si držím stále pod výrobkem, abych mohla mírně utáhnout.",
      ...
      },
      {
        ...
        styl: "Ks, V",
        pouzijeme: "Háček, značkovač",
        popis: "Postupné rozháčkování. Přidáváme mezi rozháčkování krátké sloupky. V tomto případě to bude jeden krátký sloupek, rozháčkování. Celkem šestkrát. Kontrolou vám může být přepočítání ok. Vždycky se zvyšuje počet o šest, pokud nejedeme zrovna rovné řady, tam se nic nemění.",
      ...
      },
      {
        ...
        styl: "Ks, V",
        pouzijeme: "Háček, značkovač",
        popis: "Pokračujeme v postupném rozháčkování, takže už vás asi napadne, že budeme postupovat dva krátké sloupky, rozháčkování. Na konci celkem 24 oček.</p><p>Už na konci tohoto kroku vidíte, jak se naše kolečko plynule zvětšuje.",
      ...
      },
      {
        ...
        styl: "Ks, V",
        pouzijeme: "Háček, značkovač",
        popis: "Co asi bude dál? Ano, správně! Tři krátké sloupky a rozháčkování, zase celkem šestkrát a nakonec bude 30 oček k napočítání.</p><p>Naposledy se rozšíříme. Čtyři krátké sloupky a rozháčkování. Celkem šestkrát, z toho plyne, že nakonec bude 36 oček.",
      ...
      },
      {
        ...
        styl: "Ks",
        pouzijeme: "Háček, značkovač",
        popis: "Následující tři řady budou stejné. Skládat je budeme pouze z krátkých sloupků, čili rovných řad, abychom výrobku dali nějakou velikost.",
      ...
      },
      {
        ...
        styl: "Ks, A",
        pouzijeme: "Háček, značkovač",
        popis: "Vytvořenou kopuli budeme teď stahovat, abychom z ní udělali kouli. Stejně jako existuje postupné rozháčkování, tak teď se seznámíme s postupným sháčkováním. To funguje úplně stejně, ale s opačným pořadím. Rozháčkování přidává krátké sloupky do mezer, sháčkování ubírá.</p><p>Takže teď nás čekají čtyři krátké sloupky, sháčkování. Celkem šestkrát a budeme očka zase po šesti odebírat. Závěr této řady bude vyjádřen 30 očky.",
      ...
      },
      {
        ...
        styl: "Ks, A",
        pouzijeme: "Háček, značkovač",
        popis: "Tentokrát tři krátké sloupky a stažení. Už v tomto bodě jde hezky vidět, jak se nám výrobek stahuje a tvaruje.</p><p>Pokud vlastníte bezpečnostní očka, tak je teď můžete přidat a upevnit. Já je budu pro tento okamžik háčkovat.",
      ...
      },
      {
        ...
        popis: "Vytvoříme si spolu oči. Pokud se vám nechce je háčkovat, můžete si vzít filc a vystřihnout i oči. Pokud vás to háčkování zatím baví, pojďte si je se mnou uháčkovat. Magický kroužek, stejně jako v prvním kroku.</p><p>Do prvního oka uděláme pevné očko. Vytvoříme jen takto malinké očko. Postup opakujeme a vytvoříme si druhé.",
      ...
      },
      {
        ...
        styl: "Řo, Ks",
        pouzijeme: "Háček",
        popis: "Teď k té záložce. Buď uděláme řetízkové oko, nebo jenom natáhneme provázek, nebo podle videa můžeme vytvořit širší pruh. Řetízková oka podle šířky, udělám si jedno navíc. Výrobek otočím a vracím se krátkými sloupky, na konci si udělám jedno řetízkové a zase se vracím sloupky zpět. Takto opakuju, dokud nemám vyhovující délku.",
...
const poleVyrobkuEN: Array<Vyuka> = [
  {
    nazev: "chobotnicka",
    title: "Octopus",
